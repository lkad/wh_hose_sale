...
CREATE TABLE `new_table` (
  ...
  `trad_date` date NOT NULL COMMENT '交易日期',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `trad_date` (`trad_date`,`area`)
) ENGINE=InnoDB AUTO_INCREMENT=34021 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='date 日期，area 区域,normal_trad_nm';
