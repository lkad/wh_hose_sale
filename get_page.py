...
import bs4
import time 
testurl = "http://fgj.wuhan.gov.cn/mrxjspfcjtjqk/index.jhtml"
"""此页是用来获取房管局每日交易的日期和对应的url的后缀.

by : Lkad 2018/03/05 22:21
"""
page_url_base='http://fgj.wuhan.gov.cn/mrxjspfcjtjqk/index_'
...
#get the first page 
    ...
    for i in range(1, end_page_nm):
        temp_link = get_every_page_day_link(page_url_base+str(i)+'.jhtml')
